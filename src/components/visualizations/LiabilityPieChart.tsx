...
const LiabilityPieChart: React.FC<LiabilityPieChartProps> = ({ states }) => {
  // This is a simplified component that would show a pie chart of tax liability by state
            ...
            <div key={state.code} className="flex items-center text-xs">
              ...
              <span className="ml-auto text-gray-900 font-medium">
                ...
                <span className="text-gray-500 ml-1">
                  ({((state.liability / totalLiability) * 100).toFixed(1)}%)
                </span>
              </span>
            </div>
          ))}
          ...
          {otherLiability > 0 && (
            <div className="flex items-center text-xs">
              ...
              <span className="ml-auto text-gray-900 font-medium">
                ...
                <span className="text-gray-500 ml-1">
                  ({((otherLiability / totalLiability) * 100).toFixed(1)}%)
                </span>
              </span>
            </div>
          )}
